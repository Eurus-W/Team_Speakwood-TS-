...
public class ReadProp : MonoBehaviour
{
    public Text showText;
    public string fileName;
    private Props loadedProp;
    private bool isRead = false;


    public bool IsRead { get => isRead; set => isRead = value; }
    public Props LoadedProp { get => loadedProp; set => loadedProp = value; }
    ...
    private void LoadJsonDateText()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            LoadedProp = JsonUtility.FromJson<Props>(dataAsJson);
            Debug.Log(loadedProp.props);
